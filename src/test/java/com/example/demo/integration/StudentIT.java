...
public class StudentIT {
    ...
    @Test
    void canRegisterNewStudents() throws Exception {
        ...
        Student student = new Student(
                name,
                String.format("%s@tunjiTraining.org",
    ...
    @Test
    void canDeleteStudents() throws Exception {
        //given
        String name = String.format(
                "%s %s",
                faker.name().firstName(),
        ...
        String email = String.format("%s@tunjiTraining.org",
                StringUtils.trimAllWhitespace(name.trim().toLowerCase()));
